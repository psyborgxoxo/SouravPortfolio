	...
	theme: {
		...
		extend: {
			...
			boxShadow: {
				...
				'glow-cyan': '0 0 20px #00FFFF',
				'glow-blue': '0 0 20px #0099FF',
				'arc-reactor': '0 0 40px #00D4FF, inset 0 0 20px #00D4FF',
				'arc-reactor-hover': '0 0 60px #00D4FF, inset 0 0 30px #00D4FF',
			},
			animation: {
				'accordion-down': 'accordion-down 0.2s ease-out',
				'accordion-up': 'accordion-up 0.2s ease-out',
				...
				'slide-in-left': 'slide-in-left 0.6s ease-out forwards',
				'slide-in-right': 'slide-in-right 0.6s ease-out forwards',
				'arc-spin': 'arc-spin 10s linear infinite',
				'arc-pulse': 'arc-pulse 2s ease-in-out infinite',
				'spin-clockwise': 'spin-clockwise 10s linear infinite',
				'spin-counter-clockwise': 'spin-counter-clockwise 10s linear infinite',
			},
			keyframes: {
				'accordion-down': {
					from: { height: 0 },
		...
		function({ addUtilities }) {
			const newUtilities = {
				...
				'.arc-reactor-core': {
					...
					boxShadow: '0 0 40px #00D4FF, inset 0 0 20px #00D4FF',
