      ...
      gsap.fromTo(
        ...
        { height: 0 },
        {
          ...
          scrollTrigger: {
            ...
            start: `top ${getTrueViewportHeight() * 0.8}px`, // 80% of viewport height
    ...
    <section ref={experienceRef} id="experience" className="py-12 md:py-20 relative">
      <div className="container mx-auto px-4 sm:px-6">
        ...
        <div className="about-header text-center mb-10 sm:mb-12 lg:mb-14">
          <p className="text-jarvis-primary text-xs sm:text-sm font-mono tracking-widest mb-2 sm:mb-3">// WORKING DIRECTORY</p>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="relative">
            {/* Timeline Line */}
            <div className="absolute left-4 md:left-1/2 -translate-x-0.5 w-0.5 bg-gradient-to-b from-electric-blue via-neon-cyan to-electric-blue timeline-line h-full"></div>
